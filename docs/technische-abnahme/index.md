...
- Die **Fahrzeugpapiere**, wenn Höchstgeschwindigkeit und Leistung nicht in Teilegutachten spezifiziert
...
!!! tip "Konfigurator öffnet sich nicht automatisch?"
    Gib folgende Adresse in deinen Browser ein: http://192.168.12.1. Wichtig: Nutze http:// (nicht https://). Falls dein Browser eine Sicherheitswarnung anzeigt, klicke auf „Weiter zur Seite" bzw. „Continue to site". Der Legal Limit Konfigurator sollte sich dann öffnen.
...
<p align="center">
  <img src="images/Antrieb nciht endgültig gedrosselt.png" width="400" loading="lazy" alt="Ansicht des Konfigurators bei noch nicht endgültig gespeicherter Konfiguration" />
</p>
...
| Maximale Nennleistung | Gemäß Teilegutachten oder Fahrzeugpapieren; das bis zu 1,4-fache der eingetragenen Leistung ist zulässig, maximal 4 kW bei Kleinkraftrad |
...
!!! warning "Wichtig: Fahrer muss aufgesessen sein"
    Die Messung muss mit aufgesitzenem Fahrer durchgeführt werden, damit der Abrollumfang unter realen Bedingungen erfasst wird.

Der Konfigurator führt selbsterklärend durch den Prozess:

- Reifen und Boden an derselben Stelle mit Kreide markieren
- Fahrzeug genau eine Radumdrehung nach vorne schieben – System erfasst Motorumdrehungen automatisch
