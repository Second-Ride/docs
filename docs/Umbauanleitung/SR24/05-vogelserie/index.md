  ...
  <tr>
    <td valign="top" style="padding-right: 30px;">
      <ul style="list-style: none; padding-left: 0;">
        ...
        <li><input type="checkbox"> 1x Vordere Aufnahme</li>
        <li><input type="checkbox"> 1x Hintere Aufnahme</li>
        ...
        <li><input type="checkbox"> 1x Kette 110 Glieder</li>
        <li><input type="checkbox"> 4x M6 Unterlegscheiben</li>
        <li><input type="checkbox"> 4x M6 Selbstsichernde Muttern</li>
        <li><input type="checkbox"> 2x M6x20 Sechskantschraube</li>
        <li><input type="checkbox"> 1x 15mm Kantenschutz transparent</li>
      </ul>
    </td>
    <td valign="top" style="padding-left: 30px;">
      <ul style="list-style: none; padding-left: 0;">
        ...
        <li><input type="checkbox"> 1x Kontaktzunge M6 für Bremskontakt</li>
        ...
        <li><input type="checkbox"> 1x Seitenblech links</li>
        <li><input type="checkbox"> 1x Seitenblech rechts</li>
  ...
  <tr>
    ...
    <td valign="top" style="padding-left: 30px;">
      <ul style="list-style: none; padding-left: 0;">
        ...
        <li><input type="checkbox"> Evt. Maßband, Zollstock oder Messschieb</li>
      </ul>
    </td>
  </tr>
</table>
...
Zuerst werden alle elektrischen und mechanischen Verbindungen am Motor gelöst. Schraube zunächst die beiden Seitenbleche ab. Stell sicher, dass der Benzinhahn zugedreht ist und zieh den Schlauch vom Vergaser ab. Den verbleibenden Treibstoff im Tank kannst du nun mit dem Schlauch in ein geeignetes Gefäß (z.B. Benzinkanister) ablassen. Löse die Schelle der Ansaugmuffe und zieh diese vom Vergaser ab. Schraube den Gas- und Starter-Bowdenzug vom Vergaser ab, hänge den Kupplungszug aus der Halterung am Motorblock und drehe die Tachowelle aus der Halterung. Entferne nun noch den Zündkerzenstecker und das Massekabel vom Motorblock. Stecke die von der Lichtmaschine kommenden Kabel vom Fahrzeug ab. 
...
Am Lenker kannst du nun den linken Handhebel sowie den Kupplungs- und Starter/Choke-Bowdenzug demontieren. 


### 6. Sitzbank

Damit du unsere neue Sitzbank gleich montieren kannst, solltest du nun die Originale entfernen. Diese ist mit zwei Schrauben an dem Klappscharnier befestigt. Außerdem kannst du das originale Sitzbankschloss entfernen.
...
Das dicke Kabel am Antriebsmodul kannst du mit Kabelbindern bis zur Sitzbank hochbinden. 
...
Die schwarze Ader kannst du am Masse-Sammelpunkt im Lampengehäuse befestigen. Du musst übrigens keine Sicherung mehr verwenden, da die Spannungsversorgung im Falle eines Kurzschlusses automatisch abschaltet, bis der Kurzschluss wieder aufgehoben wird.
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/2d70cd04-f678-49da-9760-2d8450c8fb8a" width="200" />
</p>
...
Da der Habicht einen recht langen Tank hat, muss vor der Montage der Sitzbank der Tank so weit wie nur möglich nach vorne geschoben werden. Schraube dafür die Tankschraube lose und drücke den Tank soweit wie möglich nach vorne und schraube dann, während du den Druck aufrecht erhältst, die Tank Schraube fest. Nun sollte genug Platz sein, sodass die vordere Aufnahme nicht mit deinem Tank kollidiert.
...
Nimm dir die vormontierte Hintere Aufnahme und schraube sie lose mit den Langlöchern unterhalb der Gepäckträger Aufnahmebleche an die durchgeführten Schrauben des vorher vormontierten Gepäckträgers. Schraube nun die hintere Sitzbank Auflage (30)  an die Karosserie. 
Ziehe nun alle Schraubverbindungen ordentlich fest.
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/1b7468e4-c726-41f1-8ef4-13b01de49cd4" width="200" />
</p>
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/48576838-0597-40f6-a08d-741e64dc5c3b" width="200" />
</p>
