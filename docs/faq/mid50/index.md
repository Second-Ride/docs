...
## Welche Fahrzeuge können bis jetzt umgerüstet werden?
Da für fast jedes Fahrzeug ein eigenes Adapterkit für die Halterung des Akkus entwickelt werden muss, beschränkt sich die Auswahl bisher auf einige Simson Modelle. Hier findest du alle Kits: [Umbausätze](https://second-ride.de/produkt-kategorie/simson-umbausatz/). Wir planen allerdings schon eine lange Reihe weiterer Modelle kompatibel zu machen. Durch eine Reservierung beschleunigst du diesen Prozess: [Reservierungs-Kits](https://second-ride.de/produkt-kategorie/reservierungen/)
...
## Was kann ich tun, wenn mein Moped Modell noch nicht als Kit erhältlich ist?
Wir haben im Shop auch Modelle aufgelistet, für die wir in Zukunft ein Kit entwickeln wollen. Falls dein Modell dabei ist, kannst du einfach eine [Reservierung](https://second-ride.de/produkt-kategorie/reservierungen/) machen und signalisierst uns damit, dass ein großes Interesse an diesem Modell besteht. Die Anzahlung wird dir dann bei der finalen Bestellung angerechnet. Alternativ kannst du auch das [Adapt it Yourself Kit](https://second-ride.de/produkt/mid50-umbaukit-adapt-it-yourself/) kaufen und selbst Halterungen für dein Moped konzipieren. Dafür haben wir [alle nötigen Ressourcen Open Source](/for-developers/) gestellt.
...
## Kompatibilität mit SR24 Produkten
...
Aktuell passt in die Schwalbe nur **ein** Akku. Eine Lösung für einen Zweitakku (z.B. Gepäckträgerhalterung) ist für Sommer 2026 geplant.
...
Nein, MID50 hat SR24 komplett ersetzt. Wenn du noch ein altes Kit haben willst, frag gerne in der Community nach: [Gehe zu Discord](second-ride.de/gast)
...
Die App-Unterstützung für MID50 (inkl. Konfiguration und "Laden auf SOC-Ziel") ist für die zweite Jahreshälfte 2026 (Q3/Q4) geplant. Zum Start können Grundeinstellungen über ein temporäres Interface vorgenommen werden.
